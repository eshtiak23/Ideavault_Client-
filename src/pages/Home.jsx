    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-sky-100 via-purple-100 to-pink-100 py-16 md:py-24">
        <div className="container-box grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg mt-5">{currentSlide.text}</p>

            <Link to="/ideas">
              <button className="primary-btn mt-8">Explore Ideas</button>
            </Link>
      ...
      <section className="container-box py-20">
        <div className="text-center">
          <p className="text-pink-500 font-semibold">Trending Startup Ideas</p>
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
           Explore New Startup Ideas From Different People.
          </p>
        </div>
